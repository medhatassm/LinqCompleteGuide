...
{
        public static class RepositoryForSelect
        {

                public static IEnumerable<EmployeeForSelect> LoadEmployees()
                {
                        return new List<EmployeeForSelect>
            {
            new EmployeeForSelect
                {
                        Id = 1001,
                        FirstName = "Cochran",
                        LastName = "Cole",
